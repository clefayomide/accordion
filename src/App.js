...
function App() {
  const [title, setTitle] = useState("questions and answers about login");
  const [accordions, setAccordion] = useState([
    ...
    },
    {
      ...
      answer:
        "Coloring book forage photo booth gentrify lumbersexual. Migas chillwave poutine synth shoreditch, enamel pin thundercats fashion axe roof party polaroid chartreuse.S",
    },
    {
        ...
        <div className="flexed-container">
          ...
          <div className="accordion-cards">
            {accordions.map((accordion, index) => {
              return <Cards accordion={accordion} key={index} />
            })}
          </div>
        </div>
      </main>
